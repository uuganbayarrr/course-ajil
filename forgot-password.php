...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Нууц үг сэргээх</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- privacy ---->
<div class="privacy">
	<div class="container">
		...
		<form name="chngpwd" method="post" onSubmit="return valid();" class="wow zoomIn animated animated">
	...
	<p style="width: 350px;">
			...
			<b>Гар утас</b>  <input type="text" name="mobile" class="form-control" id="mobile" placeholder="Reg Mobile no" required="">
	</p> 
...
<b>Дахиад нууц үг</b>
	<input type="password" class="form-control" name="confirmpassword" id="confirmpassword" placeholder="Confrim Password" required="">
			...
			<p style="width: 350px;">
<button type="submit" name="submit50" class="btn-primary btn">Солих</button>
			</p>
			</form>
