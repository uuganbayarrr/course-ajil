...
<div class="privacy">
	<div class="container">
		<h3 class="wow fadeInDown animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: fadeInDown;">Profile хуудас</h3>
		<form name="chngpwd" method="post" class="wow fadeInDown animated animated">
...
{	?>
	...
	<p style="width: 350px;">
			...
			<b>Нэр</b>  <input type="text" name="name" value="<?php echo htmlentities($result->FullName);?>" class="form-control" id="name" required="">
	</p> 
...
<?php }} ?>
			...
			<p style="width: 350px;">
<button type="submit" name="submit6" class="btn-primary btn">Шинэчлэх</button>
			</p>
			</form>
