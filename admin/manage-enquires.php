...
<body>
    <div class="page-container">
        ...
        <div class="left-content">
            ...
            <!--heder end here-->
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="index.php">Нүүр хуудас</a><i class="fa fa-angle-right"></i>Санал асуулгууд удирдах</li>
            </ol>
            <div class="agile-grids">    
                ...
                <div class="agile-tables">
                    <div class="w3l-table-info">
                        <h2>Санал асуулгууд удирдах</h2>
                        <table id="table">
                            <thead>
                                <tr>
                                    <th>Тикет дугаар</th>
                                    <th>Нэр</th>
                                    <th>Гар утас/И-мэйл</th>
                                    <th>Гарчиг </th>
                                    <th>Тайлбар </th>
                            ...
                            <tbody>
                                ...
                                ?>      
                                    <tr>
                                        ...
                                        ?><td>Уншигдсан</td>
                                        <?php } else {?>
                                        <td><a href="manage-enquires.php?eid=<?php echo htmlentities($result->id);?>" onclick="return confirm('Та үнэхээр унших уу')" >Хүлээгдэж байгаа</a></td>
                                        <?php } ?>
                                    </tr>
                                <?php 
                                    } 
