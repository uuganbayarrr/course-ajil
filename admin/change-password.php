...
<!--heder end here-->
	<ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="dashboard.php">Нүүр</a><i class="fa fa-angle-right"></i>Нууц үг</li>
            </ol>
		<!--grid-->
 	<div class="grid-form">
  ...
  <div class="panel-body">
					<form  name="chngpwd" method="post" class="form-horizontal" onSubmit="return valid();">
						...
						<div class="form-group">
							<label class="col-md-2 control-label">Одоо</label>
							<div class="col-md-8">
	...
	<div class="form-group">
							<label class="col-md-2 control-label">Шинэ</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-key"></i>
	...
	<div class="form-group">
							<label class="col-md-2 control-label">Батлах</label>
							<div class="col-md-8">
								<div class="input-group">
									<span class="input-group-addon">
										<i class="fa fa-key"></i>
