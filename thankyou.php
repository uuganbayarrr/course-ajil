...
<div class="banner-1 ">
	<div class="container">
		<h1 class="wow zoomIn animated animated" data-wow-delay=".5s" style="visibility: visible; animation-delay: 0.5s; animation-name: zoomIn;">Таны хийсэн үйлдэл амжилттай.</h1>
	</div>
</div>
<!--- /banner-1 ---->
<!--- contact ---->
<div class="contact">
	<div class="container">
	<h3 class="wow zoomIn animated "> Админ таны хүсэлтыг хүлээн авч хариу хийтэл хүлээнэ үү.</h3>
